...
namespace GTASaveData.GTA3.Tests
{
        ...
        where T : SaveDataObject, new()
    {
        public static IEnumerable<object[]> FileFormats => new[]
        {
            ...
            new object[] { SaveFileGTA3.FileFormats.PS2_AU },
            new object[] { SaveFileGTA3.FileFormats.PS2_JP },
        ...
        public static IEnumerable<object[]> TestFiles => new[]
        {
            ...
            new object[] { SaveFileGTA3.FileFormats.PS2_AU, "AS3" },
            new object[] { SaveFileGTA3.FileFormats.PS2_AU, "CAT2" },
            new object[] { SaveFileGTA3.FileFormats.PS2_AU, "T4X4_2" },
            new object[] { SaveFileGTA3.FileFormats.PS2_JP, "LM1" },
            new object[] { SaveFileGTA3.FileFormats.PS2_JP, "LM2" },
            new object[] { SaveFileGTA3.FileFormats.PS2_JP, "LM2 Cheats" },
