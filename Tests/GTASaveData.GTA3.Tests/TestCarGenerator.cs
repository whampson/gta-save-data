...
namespace GTASaveData.GTA3.Tests
{
    ...
    {
        public override CarGenerator GenerateTestObject(FileType format)
        {
        ...
        {
            CarGenerator x0 = GenerateTestObject(format);
            CarGenerator x1 = CreateSerializedCopy(x0, format, out byte[] data);
