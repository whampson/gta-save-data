    ...
    public class TestPhysicalObject : Base<PhysicalObject>
    {
        public override PhysicalObject GenerateTestObject(FileFormat format)
        {
            Faker<PhysicalObject> model = new Faker<PhysicalObject>()
                ...
                .RuleFor(x => x.CostValue, f => f.Random.Short())
                .RuleFor(x => x.BonusValue, f => f.Random.Byte())
                .RuleFor(x => x.UseCarColors, f => f.Random.Bool())
        ...
        public void RandomDataSerialization(FileFormat format)
        {
            ...
            Assert.Equal(x0.CostValue, x1.CostValue);
            Assert.Equal(x0.BonusValue, x1.BonusValue);
