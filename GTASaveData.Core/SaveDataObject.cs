...
namespace GTASaveData
{
    ...
    public abstract class SaveDataObject : ObservableObject, ISaveDataObject
    {
        ...
        /// <summary>
        /// Called immediately before <see cref="ReadData(DataBuffer, FileFormat)"/> is executed.
        /// </summary>
        protected virtual void OnReading(FileFormat fmt) { }

        /// <summary>
        /// Called immediately after <see cref="ReadData(DataBuffer, FileFormat)"/> is executed.
        /// </summary>
        protected virtual void OnRead(FileFormat fmt) { }

        /// <summary>
        /// Called immediately before <see cref="WriteData(DataBuffer, FileFormat)"/> is executed.
        /// </summary>
        protected virtual void OnWriting(FileFormat fmt) { }

        /// <summary>
        /// Called immediately after <see cref="WriteData(DataBuffer, FileFormat)"/> is executed.
        /// </summary>
        ...
        /// </summary>
        /// <remarks>
        /// This method is called by <see cref="ISaveDataObject.ReadData(DataBuffer, FileFormat)"/>;
        ...
        /// </summary>
        /// <remarks>
        /// This method is called by <see cref="ISaveDataObject.WriteData(DataBuffer, FileFormat)"/>;
        /// it should not be called directly.
        /// </remarks>
