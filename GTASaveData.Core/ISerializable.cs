namespace GTASaveData
{
    ...
    public interface ISerializable
    {
        ...
        /// using the specified <see cref="DataFormat"/> to control how data is read.
        /// </summary>
        /// <param name="buf">The buffer to read from.</param>
        /// <param name="fmt">The data format.</param>
        /// <returns>The number of bytes read.</returns>
        int ReadObjectData(StreamBuffer buf, DataFormat fmt);

        /// <summary>
        /// Serializes the object by writing its data to the specified <see cref="StreamBuffer"/>
        /// using the specified <see cref="DataFormat"/> to control how data is written.
        /// </summary>
